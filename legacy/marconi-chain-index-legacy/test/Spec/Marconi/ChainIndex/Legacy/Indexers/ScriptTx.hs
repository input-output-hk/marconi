...
module Spec.Marconi.ChainIndex.Legacy.Indexers.ScriptTx (tests) where
...
import Gen.Marconi.ChainIndex.Legacy.Types (genTxBodyWithTxIns, genWitnessAndHashInEra)
...
--   let -- The following execution unit and fee values were found by
...
--   -- For more details see https://github.com/IntersectMBO/plutus-apps/issues/775
