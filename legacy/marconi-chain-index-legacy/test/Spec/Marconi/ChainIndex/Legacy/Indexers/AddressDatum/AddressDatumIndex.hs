...
module Spec.Marconi.ChainIndex.Legacy.Indexers.AddressDatum.AddressDatumIndex (
  tests,
) where
...
import Gen.Marconi.ChainIndex.Legacy.Types (genAddressInEra, genChainPoints)
