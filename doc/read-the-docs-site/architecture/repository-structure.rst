...
Particularly, it uses the types and functions defined in the Cardano core libraries: `cardano-api <https://github.com/IntersectMBO/cardano-api>`_, `ouroboros-network <https://github.com/IntersectMBO/ouroboros-network>`_, `ouroboros-consensus <https://github.com/IntersectMBO/ouroboros-consensus>`_ and `cardano-ledger <https://github.com/IntersectMBO/cardano-ledger>`_.
However, at the moment, `marconi-cardano-core` mostly uses `cardano-api` as it's a library that integrates the most useful parts, from a client application's perspective, of `ouroboros-network <https://github.com/IntersectMBO/ouroboros-network>`_, `ouroboros-consensus <https://github.com/IntersectMBO/ouroboros-consensus>`_ and `cardano-ledger <https://github.com/IntersectMBO/cardano-ledger>`_.
