...
module Marconi.Sidechain.Api.JsonRpc.Endpoint.EpochActiveStakePoolDelegation (
...
import Marconi.Cardano.ChainIndex.Api.JsonRpc.Endpoint.EpochState qualified as ChainIndex
