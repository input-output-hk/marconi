...
-}
module Spec.Marconi.Sidechain.Api.JsonRpc.Endpoint.PastAddressUtxo where
...
import Marconi.Sidechain.Api.JsonRpc.Endpoint.PastAddressUtxo qualified as Sidechain
