...
module Marconi.ChainIndex.Experimental.Api.Rest.Endpoint.TargetAddresses where

import Cardano.Api (serialiseAddress)
import Control.Lens (view)
import Data.Text (Text)
import Marconi.ChainIndex.Experimental.Api.Types (HttpServerConfig, configTrackedAddresses)
